...
<jsp:include page="/includes/bootstrap.jsp" flush="false">
    ...
    <jsp:param name="link" value='<link rel="stylesheet" type="text/css" href="bower_components/bootstrap-duallistbox/dist/bootstrap-duallistbox.min.css" />' />
    ...
    <script src="bower_components/bootstrap-duallistbox/dist/jquery.bootstrap-duallistbox.js"></script>
